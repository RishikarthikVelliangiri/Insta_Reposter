...
def repost_video(video_url, custom_caption=None, custom_hashtags=None, source="instagram"):
    ...
    try:
        ...
        print(f"Raw caption input: '{custom_caption}'")
        print(f"Raw hashtags input: '{custom_hashtags}'")
        ...
        if custom_caption and isinstance(custom_caption, str) and custom_caption.strip():
            ...
            print(f"Using default caption: {caption_text}")
        ...
        if custom_hashtags and isinstance(custom_hashtags, str) and custom_hashtags.strip():
            ...
            print(f"Using default hashtags: {hashtags_text}")
        ...
        print(f"Unexpected error during repost process: {e}")
        print("STEP_MARKER: UPLOAD_FAILED")
        return False
    finally:
...
if __name__ == "__main__":
    ...
    print(f"Received arguments: URL={args.url}, Caption={args.caption}, Hashtags={args.hashtags}, Source={args.source}")
    ...
    if args.url:
        try:
            ...
            print(format_api_result(False, f"Error: {str(e)}"))
    else:
